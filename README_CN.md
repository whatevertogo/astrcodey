...
| [`astrcode-server`](crates/astrcode-server) | 13.5k | 会话管理、HTTP/SSE API、ACP WebSocket、投影与 SSE |
...
- 基于 HTTP WebSocket（`GET /api/acp/ws`，与 REST 共用 Bearer 鉴权）的 ACP JSON-RPC：Initialize / NewSession / Prompt / Cancel
