...
export const composerShell =
  'rounded-[20px] border border-border bg-surface shadow-[0_8px_28px_rgba(0,0,0,0.06)] transition-[border-color,box-shadow] duration-150 focus-within:border-border-strong focus-within:shadow-[0_10px_32px_rgba(0,0,0,0.09)]'
