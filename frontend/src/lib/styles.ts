...
export const ghostIconButton =
  'inline-flex items-center justify-center rounded-lg text-text-secondary transition-[background-color,color,opacity] duration-150 ease-out hover:bg-black/5 hover:text-text-primary'
...
export const composerSubmitButton =
  'inline-flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-accent-strong text-white shadow-soft transition-[transform,filter,opacity] duration-150 ease-out hover:-translate-y-px hover:scale-105 hover:brightness-95 disabled:cursor-not-allowed disabled:opacity-35 [&_svg]:h-4 [&_svg]:w-4'
...
export const dialogSurface =
  'rounded-[20px] border border-border bg-surface p-6 shadow-surface-lg'
